...
export class OtherDomainController {
  ...
  @Post('create')
  @HttpCode(201)
  async createOtherDomain(@Body() createOtherDomainDTO: ICreateOtherDomainDTO): Promise<void> {
  ...
  @Patch(':id')
  @HttpCode(200)
  async update(@Param('id') id: string, @Body() body: IUpdateOtherDomainDTO): Promise<void> {
